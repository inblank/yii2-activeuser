...
class UserTest extends TestCase
{
    ...
    public function testCreation()
    {
        ...
        $this->specify("we have create user with register email", function () {
            ...
            expect("we must see email", MailMock::$mails[0]['to'])->equals($user->email);
            expect("we must see registration email", MailMock::$mails[0]['subject'])->contains('register');
        });
    ...
    public function testRegistration()
    {
        ...
        $this->specify("we have register user without confirm email", function () {
            ...
            expect("we must view registration email", MailMock::$mails[0]['to'])->equals($user->email);
            expect("we must view registration email", MailMock::$mails[0]['subject'])->contains('register');
        });
    }
